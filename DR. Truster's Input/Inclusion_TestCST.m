...
nel = 3; %max number of nodes per element
numgh = 3;4;8;7;6; %number of grains along horiz. edge
numgs = 3;4;8;7;6; %number of grains along later. edge
...
m2 = [100 0 1];[100 0.25 1]; %material type 1
m1 = [200 0 1];[200 0.25 1]; %material type 2
