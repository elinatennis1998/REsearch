function [ElemK,ElemF,hr,Disp] = L_Elem1_2d100(mateprop,ul,xl,ElemFlag,hr,nh1,nh2,nh3,ndf,ndm,nst,nel,nen,lintt3,lintq4,lintt6,lintq9,PSPS,iprob)
...
col2 = [2; 1];
        ...
        ulres2 = reshape(ul(1:ndm,1:nel),ndf*nel,1);
...
%             Disp = reshape(([shl shl])',ndf*nel,1).*reshape(ul(:,1:nel),ndf*nel,1);
        end %je
        Disp(1,:) = Nmat(1,:).*ulres2';
        Disp(2,:) = Nmat(2,:).*ulres2';