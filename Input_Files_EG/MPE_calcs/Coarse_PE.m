...
bCrys = 1;8;1;3; %number of elem. along grain edge
CS_flag = 1; %Flag to collect data for post processing
MRDGF = 2;0;1; %1 - include only interface; 2 - include 
MRDGF_Iplot = 1; %IntA 2; %IntB 3; %IntC
MRDGF_Eplot = 1; %ExtA 2; %ExtB 3; %ExtC 4; %ExtD; 5; %ExtE 6;ExtF
IBP = 0;
if nen == 4
    tfact = 1; %quad 1
...
TFS = 2; %2; FE 1; %Taylor 5; % Fine Scale 3; % Sachs  4; % Combo 
