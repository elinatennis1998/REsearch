...
% Elina Geut
% 9/18/2019
% Input file for homogeneous case 

clear

% Mesh with numgh x numgs tiling
PSPS = 's'; %plane stress condition 
nen = 4;3;8;6; %number of nodes per element
nel = 4;3;8;6; %max number of nodes per element
...
bCrys = 2;1;4;3;8; %number of elem. along grain edge
