...
switch isw%Task Switch
    ...
    case 50
        ...
        GrainRot = zeros(1,nummatCG); %Rotation was added 9/5/2019
        ElemEps = zeros(3,numelCG);
        ElemVol = zeros(2,numelCG);
        ElemDisp = zeros(2,numelCG);
        ElemRot = zeros(1,numelCG); %Rotation was added 9/5/2019
        AssemQuant = 'AssemIntegSEe';
end
...
%         % part for checking the Post-Processing-MRDG2.m subroutine 
% %         load('DispFine')
% %         ul = zeros(ndf, nen);
% %         ul(1:ndm,actnode) = DispFine(ElemFlag(actnode),1:ndm)';
%         ul = zeros(ndf, nen);
