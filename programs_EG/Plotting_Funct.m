...
plotElemCont2(Coordinates,GrainAveD,NodesOnElement(1:numelCG,1:4),1,(1:size(NodesOnElement,1)),[1 0 0])
plotElemCont2(Coordinates,RegionOnElement,NodesOnElement,1,1:(nu*nv),[1 0 0])